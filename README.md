# chopin-opus-42
[LilyPond](https://lilypond.org/) engraving source files used to create Chopin's Waltz, opus 42.
...
The PDF and MIDI files can be created by issuing the following command in the directory this file is in (assuming you have `lilypond` in your PATH variable):
        ...
        lilypond waltz-op42.ly

To create a smaller PDF, try:

        lilypond -dno-point-and-click waltz-op42.ly

You may also [download the latest release](https://github.com/ksnortum/chopin-opus-42/releases/latest) to get the compiled PDF and MIDI files.
